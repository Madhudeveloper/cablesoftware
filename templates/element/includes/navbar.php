<div class="page-header row">
  <div class="header-logo-wrapper col-auto">
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?php echo $this->Url->build('/assets/images/logo/logo.png'); ?>" alt=""/><img class="img-fluid for-dark" src="<?php echo $this->Url->build('/assets/images/logo/logo_light.png'); ?>" alt=""/></a></div>
  </div>
  ...
  <div class="header-wrapper col m-0">
    <div class="row">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<?php echo $this->Url->build('/assets/images/logo/logo.png'); ?>" alt=""></a></div>
      ...
      <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
        <ul class="nav-menus">
          <li>                         <span class="header-search">
              <svg>
                <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#search'); ?>"></use>
              </svg></span></li>
          <li>
            <div class="form-group w-100">
              <div class="Typeahead Typeahead--twitterUsers">
          ...
          <li class="fullscreen-body">                       <span>
              <svg id="maximize-screen">
                <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#full-screen'); ?>"></use>
              </svg></span></li>
          <li class="onhover-dropdown">
            <div class="notification-box">
              <svg>
                <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#notification'); ?>"></use>
