    ...
    <ul class="sidebar-links" id="simple-bar">
      ...
      <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
          <svg class="stroke-icon">
            <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#stroke-home'); ?>"></use>
          </svg>
          <svg class="fill-icon">
      ...
      <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
          <svg class="stroke-icon">
            <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#stroke-widget'); ?>"></use>
          </svg>
          <svg class="fill-icon">
     ...
     <!--  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
          <svg class="stroke-icon">
            <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#stroke-layout'); ?>"></use>
          </svg>
          <svg class="fill-icon">
            <use href="<?php echo $this->Url->build('/assets/svg/icon-sprite.svg#fill-layout'); ?>"></use>
